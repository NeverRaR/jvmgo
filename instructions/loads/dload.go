...
func (receiver *DLOAD) Execute(frame *rtda.Frame) {
	_dload(frame, receiver.Index)
}

type DLOAD_0 struct{ base.NoOperandsInstruction }

func (receiver *DLOAD_0) Execute(frame *rtda.Frame) {
	_dload(frame, 0)
}

type DLOAD_1 struct{ base.NoOperandsInstruction }

func (receiver *DLOAD_1) Execute(frame *rtda.Frame) {
	_dload(frame, 1)
}

type DLOAD_2 struct{ base.NoOperandsInstruction }

func (receiver *DLOAD_2) Execute(frame *rtda.Frame) {
	_dload(frame, 2)
}

type DLOAD_3 struct{ base.NoOperandsInstruction }

func (receiver *DLOAD_3) Execute(frame *rtda.Frame) {
	_dload(frame, 3)
}
